...
public class MyDatabase extends SQLiteOpenHelper {
    ...
    public static final String DB_NAME = "car_db"; //ملف الداتا بيس يكون نفس اسم car_db
    public static final int DB_VERSION = 2;//اصدار الداتا بيس, وعند تحديث الجدول يجب اعطاء قيمة اكبر من السابقة مثلا القيمة 1 نجعلها 2 بد التحديث واذا كانت 4 نجعلها 5 بعد التحديث
